...
const NAV_ITEMS = [
  { path: "/",         label: "Dashboard",      icon: LayoutDashboard, color: "text-blue-400",    badge: null },
  { path: "/dsa",      label: "DSA Visualizer", icon: GitBranch,       color: "text-emerald-400", badge: "9"  },
  { path: "/sql",      label: "SQL Playground", icon: Database,        color: "text-cyan-400",    badge: null },
  { path: "/os",       label: "OS Simulator",   icon: Cpu,             color: "text-amber-400",   badge: null },
  { path: "/review",   label: "AI Code Review", icon: Code2,           color: "text-green-400",   badge: null },
...
export default function Sidebar({ collapsed, setCollapsed, totalXP, currentLevel, progress, nextLevel }) {
  return (
    <aside
      className={
    ...
    >
      ...
      <nav className="flex-1 py-3 px-2 space-y-1 overflow-y-auto">
        {!collapsed && (
          <p className="text-[10px] text-slate-500 uppercase tracking-widest px-2 py-2">
            Navigation
          </p>
        )}
      ...
      {!collapsed && totalXP !== undefined && currentLevel && (
          ...
          <div className="bg-slate-800 rounded-xl p-3 border border-slate-700">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className={"text-xs font-semibold " + currentLevel.color}>
                    {currentLevel.title}
                  </p>
